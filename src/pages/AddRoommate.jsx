...
const AddRoommate = () => {
    ...
    "Quiet", "Social", "Vegetarian", "Non-Vegetarian",
    "Parties Welcome", "No Parties", "Students Preferred", "Professionals Preferred"
  ];
      ...
      <div className="bg-amber-100 px-4 md:px-8 py-6 mx-8 md:mx-20 my-8 rounded-lg">
        ...
        <form onSubmit={handleSubmit}>
          <p className="text-gray-700 font-semibold mb-8">
            Fill out the details below to find out your perfect roommate
          </p>
          {/* title */}
          <div className="mb-8">
            <label
          ...
          <div className="flex items-center justify-center">
            <button
              type="submit"
              className={`bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded-full focus:outline-none focus:shadow-outline transition duration-300}`}
            >
              Add Listing
            </button>
          </div>
