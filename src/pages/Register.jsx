...
const Register = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // contact firebase for creating user using email & password
  ...
  return (
    <div>
      <div className="flex justify-center mt-20">
        <div className="w-full max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-300 dark:text-gray-800">
          ...
          >
            <div className="space-y-1 text-sm">
              <label htmlFor="userName" className="block dark:text-gray-800">
                User Name
              </label>
              <input
                type="text"
            ...
            <div className="space-y-1 text-sm">
              <label htmlFor="emailId" className="block dark:text-gray-800">
                User Email
              </label>
              <input
                type="text"
            ...
            <div className="space-y-1 text-sm">
              <label htmlFor="userPhoto" className="block dark:text-gray-800">
                User Photo URL
              </label>
              <input
                type="text"
            ...
            <div className="text-sm">
              <label htmlFor="password" className="block dark:text-gray-800">
                Password
              </label>
