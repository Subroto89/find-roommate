...
const AppAbout = () => {
  return (
    <div className="flex items-center justify-around">
      <div className="w-full p-8 md:p-20 bg-amber-100 text-gray-600">
        ...
        <Link className="text-lg font-semibold border-1 border-gray-400 hover:border-2 px-3 py-1"> Get Started</Link>
      </div>
      <div>
        <img src={appAbout}/>
      </div>
